...
function QuoteForm() {
  ...
  const [formData, setFormData] = useState({
    ...
    terms_conditions:
      "Betaling binnen 14 dagen na factuurdatum. Standaard leveringsvoorwaarden van toepassing.",
  });
    ...
    try {
      ...
      setFormData({
        ...
        terms_conditions:
          ...
          "Standaard leveringsvoorwaarden van toepassing.",
      });
              ...
              <table className="min-w-full">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="text-left py-2 text-sm font-medium text-gray-700 w-20">
                      Aantal
                    </th>
                    <th className="text-left py-2 text-sm font-medium text-gray-700 w-24">
                      Prijs
                    </th>
                    <th className="text-left py-2 text-sm font-medium text-gray-700 w-20">
                      BTW%
