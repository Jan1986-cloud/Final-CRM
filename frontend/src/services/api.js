...
export const invoiceService = {
  ...
  createFromWorkOrders: (workOrderIds) =>
    api.post("/invoices/from-work-orders", { work_order_ids: workOrderIds }),
...
export const excelService = {
  ...
  exportArticles: () =>
    api.get("/excel/articles/export", { responseType: "blob" }),
  importArticles: (file) => {
    const formData = new FormData();
    formData.append("file", file);
  ...
  getCustomerTemplate: () =>
    api.get("/excel/templates/customers", { responseType: "blob" }),
  getArticleTemplate: () =>
    api.get("/excel/templates/articles", { responseType: "blob" }),
};
